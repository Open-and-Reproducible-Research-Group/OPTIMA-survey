...
list(
  ...
  tar_quarto(survey_analysis,
             ...
             quiet = FALSE),
  tar_quarto(survey_analysis_over_time,
             "analysis_notebooks/survey_analysis_over_time.qmd",
             quiet = FALSE),
  tar_quarto(survey_analysis_groups,
             "analysis_notebooks/survey_analysis_groups.qmd",
             quiet = FALSE),
