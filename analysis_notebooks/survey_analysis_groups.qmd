...
```{r os_roles, fig.height = 10, fig.width = 7.5}
...
```{r raia_roles, fig.height = 9.6, fig.width = 7.5}
...
```{r os_students, fig.height = 10, fig.width = 7.5}
...
```{r raia_students, fig.height = 9.6, fig.width = 7.5}
...
```{r raia_surveys, fig.height = 9.6, fig.width = 7.5}
