...
To compare agreement over time across groups, the responses were dichotomized into agreement ("rather agree", "strongly agree") and disagreement ("rather disagree", "strongly disagree"). This way the percentage of respondents agreeing with a certain statement can be compared across groups and over time. Missing responses and "don't know" answers were removed before the percentage of agreement was calculated. As in the previous section, percentages refer to all respondents that chose one of the response categories presented (and not "don't know").
...
In the plots above, students were all grouped into one category. Since it is of interest how students' perceptions differ depending on the stage of their studies, they are compared more closely in the subsequent figures.
