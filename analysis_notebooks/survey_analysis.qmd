...
```{r os_overview, fig.height = 5, fig.width = 10, results='asis'}
...
```{r raia_overview, fig.height = 5, fig.width = 10, results='asis'}
...
```{r raif_overview, fig.height = 4, fig.width = 10, results='asis'}
...
```{r os_development, fig.height = 8, fig.width = 7.5, results='asis'}
