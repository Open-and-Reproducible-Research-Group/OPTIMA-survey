...
```{r academic_role, fig.width = 6, fig.height = 3}
roles <- df %>% 
...
ggplot(roles, aes(percent, roles)) +
  geom_col(width = 0.8, color = "black", linewidth = 0.7, fill = "#a6cee3") +
  geom_text(aes(label = scales::label_comma()(n)), 
    hjust = 0, nudge_x = .01, size = 10, size.unit = "pt") +
